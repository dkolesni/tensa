...
IR result: randn_like/exp/mean; randomness is library vocabulary (H-010), not AST syntax.
...
Finding classification: H-010 and F-023 fixed; E-003/G-cand-005 cursor visibility.
...
Regression test added?: challenge:vae H-010 check; backend F-023; flow G-cand-005; GPU gate.
